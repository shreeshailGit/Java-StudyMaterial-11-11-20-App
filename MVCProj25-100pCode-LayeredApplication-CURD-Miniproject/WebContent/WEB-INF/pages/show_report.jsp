  ...
  <c:when test="${empsInfo ne null && !empty empsInfo }">
   <table   class="table  table-hover table-bordered  table-stripped table-sm">
      ...
      <c:forEach var="dto" items="${empsInfo}">
         ...
         <td>${dto.netSal}</td>
         <td>${dto.deptno}</td>
         <td><a href="editEmp.htm?eno=${dto.empNo }"><img src="images/edit1.png" width="50" height="50"/></a>
         <a href="deleteEmp.htm?eno=${dto.empNo }" onclick="return confirm('Are you sure to delete ${dto.ename} ?')"><img src="images/delete1.jpg" width="50" height="50"/></a></td>
         </tr>                                                                                 
      </c:forEach>
   </table>   
  </c:when> 
...
<a href="saveEmp.htm"><img  src="images/add1.jpg" width="100" height="100"/></a>
